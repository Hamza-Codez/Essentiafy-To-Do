 ...
 min-h-screen min-w-fit mb-0 ">
  ...
  <div className="flex gap-5">
    <a className={`${aTagStyle} flex items-center gap-2`}    
      ...
      <img className="w-5 lg:w-[1.6rem] md:w-[1.4rem]" src="/Images/facebook.png" alt="Facebook Logo" />
    </a>
    ...
    <a className={`${aTagStyle} flex items-center gap-2`}    
      ...
      <img className="w-5 lg:w-[1.6rem] md:w-[1.4rem]" src="/Images/linkedin.png" alt="LinkedIn Logo" />
    </a>
    ...
    <a className={`${aTagStyle} flex items-center gap-2`}    
      ...
      <img className="w-5 lg:w-[1.6rem] md:w-[1.5rem]" src="/Images/instagram.png" alt="Instagram Logo" />
    </a>
    
    <img className="w-5 block sm:block md:w-[1.5rem] lg:hidden" onClick={scroller} style={{ cursor: 'pointer' }} src="/Images/icons8-arrow-up-100 (1).png" />        
  </div>
  <img className="w-5 lg:w-[2rem] hidden lg:pl-[12rem] lg:block" onClick={scroller} style={{ cursor: 'pointer' }} src="/Images/icons8-arrow-up-100 (1).png" />        
</footer>
